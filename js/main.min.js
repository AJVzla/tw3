 ...
 * Table of contents: 
 * main.js
 * Generated by MagicMin: 2020-06-07 05:08:54
 */
$(document).ready(function(){setTimeout(function(){$('.loading').fadeTo("fast",0.5);$('.loading').fadeOut("slow");$('html').css("overflow","visible");},2000)
$(document).ready(function(){$('.hamburger').click(function(){$(this).toggleClass('is-active');$('.let').toggleClass('is-active');});});$(document).ready(function(){$('.let li a').click(function(){$('hamburger').toggleClass('is-active');$('.let').toggleClass('is-active');});});$(window).scroll(function(){var $cabecera=$('.let');var $cabeceras=$('.cabecera');if($(window).scrollTop()>20){$cabecera.addClass('scroll-bar');$cabeceras.addClass('hide');}else{$cabecera.removeClass('scroll-bar');$cabecera.removeClass('is-active');$cabeceras.removeClass('hide');}});var $cabecera=$('.cabecera');var previousScroll=0;$(window).scroll(function(event){var scroll=$(this).scrollTop();if(scroll>previousScroll&&scroll>400){$cabecera.addClass('ocultar');$(".navbar-collapse").removeClass("in").addClass("collapse");$(".hamburger").removeClass("is-active");}else{$cabecera.removeClass('ocultar');}
previousScroll=scroll;});if(cargarPlugin('tabs')){cargarRecursos([{tipo:'js',src:'js/jquery.tabs/jquery.tabs.min.js'},],function(){$(window).resize(function(){if($(window).width()>990){if(window.tabs===undefined){window.tabs=$('.tab-seccion').tabs({autoRotate:2500,alwaysScrollToTop:false});}}else{if(window.tabs!==undefined){$('.tab-seccion').destroyTabs();window.tabs=undefined;}}}).resize();});if($(window).width()<990){$(".mobile-tittle").click(function(e){$(".mobile-tittle").removeClass('selected');$(this).addClass('selected');var desplegable=$(this).next();$('.js-cont-desplegable').not(desplegable).slideUp('fast');desplegable.slideToggle('fast');});}}
